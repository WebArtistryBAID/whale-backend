...
Revision ID: 45da92ebb376
Revises: 
Create Date: 2024-04-17 20:48:03.160083
...
def upgrade() -> None:
    ...
    sa.Column('contactRoom', sa.String(length=5), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('salePercent', sa.Float(), nullable=True),
